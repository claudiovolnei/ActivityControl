...
namespace ActivityControlWebAPI.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class UsersController : ControllerBase
    {
        private readonly ActivityControlDBContext _context;
        private readonly JWTSettings _jwtsettings;
        private readonly IMapper _mapper;

        public UsersController(ActivityControlDBContext context, IOptions<JWTSettings> jwtsettings, IMapper mapper)
        {
            _context = context;
