...
{
    public partial class ActivityControlDBContext : DbContext
    {
        private readonly IHttpContextAccessor _httpContextAccessor;
        public ActivityControlDBContext()
        {
        }

        public ActivityControlDBContext(DbContextOptions<ActivityControlDBContext> options, IHttpContextAccessor httpContextAccessor)
            : base(options)
        {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlite("Data source=C:\\Users\\psclaud\\MVPs\\ActivityControl\\ActivityControl.db");
            }
        }
