        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    last_name = table.Column<string>(type: "TEXT", unicode: false, maxLength: 40, nullable: false),
                    first_name = table.Column<string>(type: "TEXT", unicode: false, maxLength: 20, nullable: false),
                    phone = table.Column<string>(type: "TEXT", unicode: false, fixedLength: true, maxLength: 12, nullable: false, defaultValueSql: "('UNKNOWN')"),
                    address = table.Column<string>(type: "TEXT", unicode: false, maxLength: 40, nullable: false),
                    ...
                    zip = table.Column<string>(type: "TEXT", unicode: false, fixedLength: true, maxLength: 5, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    store_name = table.Column<string>(type: "TEXT", unicode: false, maxLength: 40, nullable: false),
                    store_address = table.Column<string>(type: "TEXT", unicode: false, maxLength: 40, nullable: false),
                    city = table.Column<string>(type: "TEXT", unicode: false, maxLength: 20, nullable: false),
                    state = table.Column<string>(type: "TEXT", unicode: false, fixedLength: true, maxLength: 2, nullable: false),
                    zip = table.Column<string>(type: "TEXT", unicode: false, fixedLength: true, maxLength: 5, nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    role_id = table.Column<short>(type: "INTEGER", nullable: false, defaultValueSql: "((1))"),
